...
void _appSettingsSerialize(
  ...
  writer.writeDateTime(offsets[0], object.firstRun);
}
...
AppSettings _appSettingsDeserialize(
  ...
  object.firstRun = reader.readDateTimeOrNull(offsets[0]);
  object.id = id;
  return object;
}
...
extension AppSettingsQueryFilter
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition> firstRunBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, DateTime?, QQueryOperations> firstRunProperty() {
    return QueryBuilder.apply(this, (query) {
